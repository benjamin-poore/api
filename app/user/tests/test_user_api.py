...
class PublicUserAPiTests(TestCase):
    ...
    def test_user_with_email_exist_error(self):
        """
        Test user creation with email already exists
        """
        payload = {
            'email': 'test@example.com',
            'password': 'test123',
    ...
    def test_create_token_for_user(self):
        """
        Test successful creation of a new token for valid credentials
        """
        user_details = {
            'email': 'test@example.com',
            'password': 'test123',
    ...
    def test_create_token_for_no_credentials(self):
        """
        Test returns error for no credentials
        """
